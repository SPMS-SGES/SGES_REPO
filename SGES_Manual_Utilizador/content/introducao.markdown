...
O utilizador interage com o **SGES** através da sua *Camada de Apresentação* com um browser de Internet. Sendo que a aplicação SGES é compativel com os seguintes browsers: *IE* versão 9 ou posterior, *Edge* , *Firefox* 40 ou posterior e *Chrome* 40 ou posterior
